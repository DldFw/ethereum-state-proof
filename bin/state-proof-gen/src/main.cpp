...
int main(int argc, char *argv[]) {
    ...
    options.add_options()("help,h", "Display help message")
            ...
            ("output,o", boost::program_options::value<std::string>(&output)->default_value("/root/mina-updated/mina-state-proof/bin/state-proof-gen/src/data/output_base"), "Output file")
